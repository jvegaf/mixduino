...
namespace VUmeters {
const uint16_t dataValues[] = {0,     1,      3,      7,      0xF,   0x1F,
...
VU vues[t_vues] = {
  VU(L1VU_SIG, L1VU_LATCH, SRCLK),
  VU(L2VU_SIG, L2VU_LATCH, SRCLK),
  VU(L3VU_SIG, L3VU_LATCH, SRCLK),
  VU(MLVU_SIG, MLVU_LATCH, SRCLK),
